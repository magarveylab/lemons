...
public class ReactionManipulator {
	...
	public static void swapReactions(IScaffold scaffold) throws BadTagException {
	...
	public static void addReactions(IScaffold scaffold) throws BadTagException {
	...
	public static void detectReactions(IScaffold scaffold) throws BadTagException {
	...
	public static void removeReactions(IScaffold scaffold) {
		IReactionList<IReaction> reactions = scaffold.reactions();
